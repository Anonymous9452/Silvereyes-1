...
# Combine all frequency data for mainland and island into single vectors
...
# Calculate median, quartiles, interquartile range, standard deviation, and standard error for mainland data
...
# Calculate median, quartiles, interquartile range, standard deviation, and standard error for island data
...
# Print the results for mainland data
...
# Print the results for island data
cat("Island Results:\n")
...
# Create a boxplot comparing mainland and island data
